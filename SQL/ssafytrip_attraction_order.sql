...
CREATE TABLE `attraction_order` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_attraction_order_plans1_idx` (`plans_id`),
  KEY `fk_attraction_order_attraction_info1_idx` (`attraction_info_id`),
  CONSTRAINT `fk_attraction_order_attraction_info1` FOREIGN KEY (`attraction_info_id`) REFERENCES `attraction_info` (`content_id`),
  CONSTRAINT `fk_attraction_order_plans1` FOREIGN KEY (`plans_id`) REFERENCES `plans` (`id`)
...
-- Dump completed on 2024-05-22 16:04:25
